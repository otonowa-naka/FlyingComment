...
namespace OutlineText
{
    ...
    public class OutlineTextControl : FrameworkElement
    {
        ...
        public void CreateText()
        {
            ...
            if (Highlight == true)
            {
                _textHighLightGeometry = _formattedText.BuildHighlightGeometry(new System.Windows.Point(0, 0));
            }
        }
        //</SnippetCreateText>
        #endregion
        ...
        /// 書式化した後の文字列高さ
        /// </summary>
        public Double FormattedTextHeight
        {
            get
            {
                return _formattedText.Height;
            }
        }
        ...
        /// 書式化した後の文字列幅
        /// </summary>
        public Double FormattedTextWidth
        {
            get
            {
